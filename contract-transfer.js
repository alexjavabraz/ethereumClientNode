...
let oldValue = await contractWithSigner.getBalance(ownerAccount);
console.log("Owner Account Balance : " + oldValue.toNumber());

let oldValue1 = await contract.getBalance(clientAccount);
console.log("client Account Balance : " + oldValue1.toNumber());

// Set a new Value, which returns the transaction
let tx = await contractWithSigner.transfer(clientAccount, 100, "Teste");
...
let newValue = await contract.getBalance(ownerAccount);
console.log("Owner Account Balance : " + newValue.toNumber());
let newValue1 = await contract.getBalance(clientAccount);
